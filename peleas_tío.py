    ...
    if opt8 == 1:
      ...
      if opt9 == 1:
        if portal.tigreA > 0:
          ...
          portal.steve.salud = portal.steve.salud - ataque - ataque2 - ataque
          print("te queda de vida:", portal.steve.salud)
          time.sleep(3)
        else:
      ...
      if opt9 == 1:
        if portal.tigreA > 0:
          ...
          print("Ya está muerto, le estas dando a un cadáver")
          time.sleep(3)
      if opt9 == 2:
        if portal.tigreB > 0:
      ...
      portal.tigreB = portal.tigreB - magic.varita
      portal.tigreC = portal.tigreC - magic.varita
      portal.tigreA = portal.tigreA - magic.varita
  ...
  if opt1 == 1:
    ...
    while portal.zombie_vida > 0:
      ...
      if opt2 == 1:
        ...
        portal.steve.salud = portal.steve.salud - ataque
        print("te queda de vida:", portal.steve.salud)
        time.sleep(3)
      elif opt2 == 2:
        ataque = random.randint(0, 3)
        ...
        portal.zombie_vida = portal.zombie_vida - magic.varita
        print("vida restante del zombie: ", portal.zombie_vida)
        print("El zombie ataca")
        print("el zombie te quita", ataque)
        portal.steve.salud = portal.steve.salud - ataque
